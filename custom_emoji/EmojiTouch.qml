...
Item {
	...
	console.log("emojiKeyboard.languageSelectPressed", emojiKeyboard.languageSelectPressed);
        if (!emojiKeyboard.languageSelectPressed) { //!keyboard.languageSelectionPopup.visible) {
	    console.log("True");
	    if(touchPoints.length === 1) {
		console.log("ONLY ONE TOUCHPOINT - TIME TO SWIPE")
	    }
	    var point = touchPoints[0]
	    console.log("point.pointId: " + point.pointId + " startX: " + point.startX + " x: " + point.x);
